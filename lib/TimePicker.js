  ...
  (0, _createClass3['default'])(Picker, [{
    ...
    value: function getPanelElement() {
      var _props2 = this.props,
          ...
          hourLength = _props2.hourLength,
          minuteLength = _props2.minuteLength,
          secondLength = _props2.secondLength;
...
Picker.propTypes = {
  ...
  hourLength: _propTypes2['default'].number,
  minuteLength: _propTypes2['default'].number,
  secondLength: _propTypes2['default'].number
};
Picker.defaultProps = {
  clearText: 'clear',
